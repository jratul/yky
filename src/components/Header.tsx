...
export function Header() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex items-center justify-between gap-4 px-[clamp(20px,5vw,80px)] py-[15px] backdrop-blur-xl bg-[#0a0a0c]/55 border-b border-white/[6%]">
      <a
        href="#top"
